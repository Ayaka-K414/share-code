import"./hamburger-BO0hkOY2.js";import{l as e,i as s,h as a}from"./hamburger-button-DJdXWerx.js";import{c as r}from"./close-button-D9acr4Xc.js";const i=""+new URL("../service/service_main.jpg",import.meta.url).href,t=""+new URL("../service/repair01.jpg",import.meta.url).href,l=""+new URL("../service/repair02.jpg",import.meta.url).href,c=""+new URL("../service/repair03.jpg",import.meta.url).href,n=""+new URL("../service/maintenance01.jpg",import.meta.url).href,o=""+new URL("../service/maintenance02.jpg",import.meta.url).href,p=""+new URL("../service/maintenance03.jpg",import.meta.url).href,m=""+new URL("../service/sale01.jpg",import.meta.url).href,h=""+new URL("../service/sale02.jpg",import.meta.url).href,d=""+new URL("../service/sale03.jpg",import.meta.url).href,v=""+new URL("../service/custom01.jpg",import.meta.url).href,g=""+new URL("../service/custom02.jpg",import.meta.url).href,f=""+new URL("../service/custom03.jpg",import.meta.url).href;document.querySelector("#app").innerHTML=`
    <div>
        <header>
            <a href="/index.html"><img class="logo" src=${e} alt="GTBサービスのロゴ" /></a>
            <nav>
                ...
                <li class="insta"><a href="https://www.instagram.com/gbtservise/" target="_blank" rel="noopener noreferrer"><img src=${s} art="Instagramアイコン"></a></li>
            </nav>
            <button class="hamburger-button" id="hamburger-button">
                <img class="hamburger-icon" src="${a}" alt="ハンバーガーメニュー" />
            </button>
        </header>
        <div class="menu" id="hamburger-menu">
            <div class="text-align-right">
                <button class="close-button" id="close-button" >
                <img class="close-icon" src="${r}" alt="閉じる" />
                </button>
            </div>
            <div class="menu-list">
                <ul>
                ...
                <section class="service">
                    <div class="service-container">
                        <div>
                            ...
                            <img class="service-img-sp" src=${i} alt="会社案内" />
                        ...
                        <img class="service-img-pc" src=${i} alt="私たちについて" />
                    </div>
                </section>
            </div>
            <article>
                <div class="article-container" id="href-repair">
                ...
                <div class="article-container" id="href-maintenance">
                    <div class="title-flex">
                ...
                <div class="article-container" id="href-sale">
                    <div class="title-flex">
                        ...
                        <div class="service-content">
                            ...
                            <figure>
                                <div class="flex-img">
                                    <img class="obj-position-left" src=${m} alt="鈑金・塗装" />
                                    <div class="img-small">
                                        <img src=${h} alt="鈑金・塗装" />
                                        <img src=${d} alt="鈑金・塗装" />
                                    </div>
                ...
                <div class="article-container" id="href-custom">
                    <div class="title-flex">
                        ...
                        <div class="service-content">
                            ...
                            <figure>
                                <div class="flex-img">
                                    <img class="obj-position-right" src=${v} alt="鈑金・塗装" />
                                    <div class="img-small">
                                        <img src=${g} alt="鈑金・塗装" />
                                        <img src=${f} alt="鈑金・塗装" />
                                    </div>
                                ...
                                <figcaption>
                                    ...
                                    <p>全塗装からパーツ塗装までご対応いたします。<br>また車だけでなくバイクのタンク、ヘルメットなど装飾品の塗装もお任せください。お客様のご要望に合わせたカスタムをご提案いたします。</p>
                                </figcaption>
                            </figure>
                        </div>
                    </div>
