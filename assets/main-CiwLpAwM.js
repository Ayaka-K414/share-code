import"./hamburger-BO0hkOY2.js";import{l as a,i as r,h as l}from"./hamburger-button-DJdXWerx.js";import{c as n}from"./close-button-D9acr4Xc.js";const e=""+new URL("../top/main.jpg",import.meta.url).href,t=""+new URL("../top/aboutus.jpg",import.meta.url).href,c=""+new URL("../top/service01.jpg",import.meta.url).href,o=""+new URL("../top/service02.jpg",import.meta.url).href,p=""+new URL("../top/service03.jpg",import.meta.url).href,g=""+new URL("../top/service04.jpg",import.meta.url).href,m=""+new URL("../top/works01.jpg",import.meta.url).href,h=""+new URL("../top/works02.jpg",import.meta.url).href,d=""+new URL("../top/works03.jpg",import.meta.url).href,f=""+new URL("../top/works04.jpg",import.meta.url).href,u=""+new URL("../top/works05.jpg",import.meta.url).href,v=""+new URL("../top/works06.jpg",import.meta.url).href,b=""+new URL("../top/instagram02.jpg",import.meta.url).href,w=""+new URL("../top/instagram03.jpg",import.meta.url).href,k=""+new URL("../top/instagram04.jpg",import.meta.url).href,x=""+new URL("../top/instagram05.jpg",import.meta.url).href;document.querySelector("#app").innerHTML=`
  <div>
    <header>
      <a href="/index.html"><img class="logo" src=${a} alt="GTBサービスのロゴ" /></a>
      <nav>
        ...
        <li class="insta"><a href="https://www.instagram.com/gbtservise/" target="_blank" rel="noopener noreferrer"><img src=${r} art="Instagramアイコン"></a></li>
      </nav>
    ...
    <div class="menu" id="hamburger-menu">
      <div class="text-align-right">
        <button class="close-button" id="close-button" >
          <img class="close-icon" src="${n}" alt="閉じる" />
        </button>
      </div>
      <div class="menu-list">
        <ul>
      ...
      <div class="bgc-beige">
        <section class="about-us">
            ...
            <div>
              ...
              <div class="about-us-text">
                ...
                <div class="about-us-link-container">
                  <a class="about-us-link" href="/aboutus/index.html">
                    <p class="text">会社案内</p>
                    <p class="arrow">→</p>
                  </a>
                </div>
          ...
          <div class="feature">
            ...
            <a class="feature-link" href="https://www.automesseweb.jp/2021/12/22/862327" target="_blank" rel="noopener noreferrer"><p>当社の看板車「バナナフィガロ」が特集されました。<span>クリックして特集サイトへ</span></p></a>
          </div>
        </section>
      </div>
      <div class="bgc-lightblue">
        ...
        <section class="service">
          ...
          <div class="card-container">
            <figure>
              <a href="/service/index.html#href-repair">
                <img class="card-img1" src=${c} alt="鈑金・塗装" />
                <figcaption>鈑金・塗装</figcaption>
              </a>
            </figure>
            <figure>
              <a href="/service/index.html#href-maintenance">
                <img class="card-img2" src=${o} alt="整備・車検" />
                <figcaption>整備・車検</figcaption>
              </a>
            </figure>
            <figure>
              <a href="/service/index.html#href-sale">
                <img class="card-img3" src=${p} alt="新車・中古車販売" />
                <figcaption>新車・中古車販売</figcaption>
              </a>
            </figure>
            <figure>
              <a href="/service/index.html#href-custom">
        ...
        <section class="works">
          <div class="flex-container">
            ...
            <div class="works-link-container">
              <a class="works-link" href="/works/index.html">
          ...
          <div class="works-link-container-tablet">
            <a class="works-link-tablet" href="/works/index.html">
              <p class="text">もっと見る</p>
              <p class="arrow">→</p>
            </a>
          </div>
      ...
      <div class="bgc-white">
        ...
        <section class="instagram">
          ...
          <div class="instagram-link-container-tablet">
            <p class="instagram-link-tablet"><a href="https://www.instagram.com/gbtservise/" target="_blank" rel="noopener noreferrer">Follow us<span class="arrow"></span></a></p>
          </div>
        </section>
...
`;document.addEventListener("DOMContentLoaded",function(){const s=document.getElementById("textContainer");let i=s.innerHTML.replace(/<br\s*\/?>/gi,`
`);s.setAttribute("data-text",i)});
