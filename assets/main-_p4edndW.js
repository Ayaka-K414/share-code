import"./hamburger-BawUfrOa.js";import{l as a,i as e,h as c}from"./hamburger-button-FxfpAW7y.js";import{c as r}from"./close-button-D8gcA_45.js";const i="/top/main.jpg",t="/top/aboutus.jpg",n="/top/service01.jpg",o="/top/service02.jpg",p="/top/service03.jpg",g="/top/service04.jpg",d="/top/works01.jpg",f="/top/works02.jpg",u="/top/works03.jpg",v="/top/works04.jpg",m="/top/works05.jpg",h="/top/works06.jpg",b="/top/instagram02.jpg",k="/top/instagram03.jpg",w="/top/instagram04.jpg",x="/top/instagram05.jpg";document.querySelector("#app").innerHTML=`
  <div>
    <header>
      ...
      <nav>
        ...
        <li class="insta"><a href=""><img src=${e} art="Instagramアイコン"></a></li>
      </nav>
      <button class="hamburger-button" id="hamburger-button">
        <img class="hamburger-icon" src="${c}" alt="ハンバーガーメニュー" />
      </button>
    </header>
...
`;document.addEventListener("DOMContentLoaded",function(){const s=document.getElementById("textContainer");let l=s.innerHTML.replace(/<br\s*\/?>/gi,`
`);s.setAttribute("data-text",l)});
