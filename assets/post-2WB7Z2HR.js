import"./hamburger-BO0hkOY2.js";import{l as s,i as e,h as a}from"./hamburger-button-DJdXWerx.js";import{c as t}from"./close-button-D9acr4Xc.js";const r=""+new URL("../post/post2304_01.jpg",import.meta.url).href,i=""+new URL("../post/post2304_02.jpg",import.meta.url).href,l=""+new URL("../post/post2304_03.jpg",import.meta.url).href,n=""+new URL("../post/post2304_04.jpg",import.meta.url).href,o=""+new URL("../post/post2304_05.jpg",import.meta.url).href,c=""+new URL("../post/post2304_06.jpg",import.meta.url).href,p=""+new URL("../post/post2304_07.jpg",import.meta.url).href;document.querySelector("#app").innerHTML=`
    <div>
        <header>
        ...
        <div class="menu" id="hamburger-menu">
            <div class="text-align-right">
                <button class="close-button" id="close-button" >
                    <img class="close-icon" src="${t}" alt="閉じる" />
                </button>
            </div>
            <div class="menu-list">
                <ul>
                ...
                <div class="img-container">
                    <div class="before img-contents">
                        ...
                        <div class="before-img">
                            <img src=${r} alt="ホンダN360のレストア" />
                            <img src=${i} alt="ホンダN360のレストア" />
                        </div>
                    </div>
                    <div class="process img-contents">
                        <p class="vertical-title">process</p>
                        <div class="process-img">
                            <img src=${l} alt="ホンダN360のレストア" />
                            <img src=${n} alt="ホンダN360のレストア" />
                            <img src=${o} alt="ホンダN360のレストア" />
                        </div>
                    </div>
                    <div class="after img-contents">
                        <p class="vertical-title">after</p>
                        <div class="after-img">
                            <img src=${c} alt="ホンダN360のレストア" />
                            <img src=${p} alt="ホンダN360のレストア" />
                        </div>
                    </div>
                </div>
