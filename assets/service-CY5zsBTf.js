import"./hamburger-BawUfrOa.js";import{l as i,i as a,h as l}from"./hamburger-button-FxfpAW7y.js";import{c as e}from"./close-button-D8gcA_45.js";const s="/service/service_main.jpg",c="/service/repair01.jpg",t="/service/repair02.jpg",r="/service/repair03.jpg",n="/service/maintenance01.jpg",o="/service/maintenance02.jpg",v="/service/maintenance03.jpg",p="/service/sale01.jpg",g="/service/sale02.jpg",d="/service/sale03.jpg",f="/service/custom01.jpg",m="/service/custom02.jpg",h="/service/custom03.jpg";document.querySelector("#app").innerHTML=`
    <div>
        <header>
        ...
        <div class="menu" id="hamburger-menu">
            <div class="text-align-right">
                ...
                <img class="close-icon" src="${e}" alt="閉じる" />
                </button>
            </div>
            <div class="menu-list">
                <ul>
                ...
                <div class="article-container">
                    <div class="title-flex">
                        ...
                        <div class="service-content">
                            ...
                            <figure>
                            <div class="flex-img">
                                <img class="obj-position-left" src=${p} alt="鈑金・塗装" />
                                <div class="img-small">
                                    <img src=${g} alt="鈑金・塗装" />
                                    <img src=${d} alt="鈑金・塗装" />
                                </div>
