import"./ress-B710VfZE.js";import{l as i,i as l,h as e}from"./hamburger-button-CWMMissQ.js";const a="/assets/service_main-C1SePJBZ.jpg",t="/assets/repair01-B7gXDg-X.jpg",c="/assets/repair02-Cf1Xd-se.jpg",r="/assets/repair03-DixyG-Si.jpg",n="/assets/maintenance01-BY3jhf4b.jpg",o="/assets/maintenance02-B-ZIh2Ri.jpg",p="/assets/maintenance03-BA8l2k7h.jpg",s="/assets/sale01-BYzYDplx.jpg",g="/assets/custom01-C289jzpA.jpg",v="/assets/custom02-Dro1NTFD.jpg",d="/assets/custom03-68KGQ_-A.jpg";document.querySelector("#app").innerHTML=`
    <div>
        <header>
        ...
        <nav>
            ...
            <li class="insta"><a href=""><img src=${l} art="Instagramアイコン"></a></li>
        </nav>
        <button class="hamburger">
            <img src="${e}" alt="ハンバーアイコン" />
        </button>
        </header>
        <main>
                ...
                <section class="service">
                    <div class="service-container">
                        <div>
                            ...
                            <img class="service-img-sp" src=${a} alt="会社案内" />
                        ...
                        <img class="service-img-pc" src=${a} alt="私たちについて" />
                    </div>
                </section>
            </div>
            <article>
